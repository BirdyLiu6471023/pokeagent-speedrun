...
- '#' is not always blocker, but may be the place that it can't see. 
...
You are in a dialogue or prompt. A textbox or Yes/No choice is visible.
...
- If a choice is visible, use arrows to select the intended option, then A on subsequent steps.
- Keep reasons short and specific to what’s visible (e.g., “textbox continues — press A”).
""" 
